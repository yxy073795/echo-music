...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      dlMetaMac: 'DMG 安装包 · macOS 12+ · 目前仅 Apple 芯片（M1/M2/M3）',
      dlBtnMac: '下载 macOS 版',
      macNote: '⚠️ Intel Mac 用户暂不可用：需要构建 x64 版，正在准备中',
    ...
    en: {
      ...
      dlMetaMac: 'DMG installer · macOS 12+ · Apple Silicon only (M1/M2/M3)',
      dlBtnMac: 'Download for macOS',
      macNote: '⚠️ Intel Mac: not yet available, x64 build in progress',
